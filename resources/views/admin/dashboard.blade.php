                ...
                <div class="table-responsive table-card mt-0">
                    <table
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <img src="{{ asset('admin/images/users/user-22.jpg') }}"
                            ...
                            <tr>
                                <td>
                                    <img src="{{ asset('admin/images/users/user-23.jpg') }}"
                                        class="avatar avatar-sm rounded-circle me-3">
                                    Janice Reese
                                </td>
                            ...
                            <tr>
                                <td>
                                    <img src="{{ asset('admin/images/users/user-19.jpg') }}"
                                        class="avatar avatar-sm rounded-circle me-3">
                                    Andrew Kim
                                </td>
                            ...
                            <tr>
                                <td>
                                    <img src="{{ asset('admin/images/users/user-20.jpg') }}"
                                        class="avatar avatar-sm rounded-circle me-3">
                                    Kathryn Sanchez
                                </td>
                            ...
                            <tr>
                                <td>
                                    <img src="{{ asset('admin/images/users/user-21.jpg') }}"
                                        class="avatar avatar-sm rounded-circle me-3">
                                    Diane Richards
                                </td>
