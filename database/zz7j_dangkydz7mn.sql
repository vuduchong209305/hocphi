...
--
-- Host: localhost
-- Generation Time: Apr 18, 2026 at 07:10 PM
...
--
-- Table structure for table `vdh_status`
--

CREATE TABLE `vdh_status` (
  `id` tinyint(4) NOT NULL,
  `name` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=DYNAMIC;

--
-- Dumping data for table `vdh_status`
--

INSERT INTO `vdh_status` (`id`, `name`) VALUES
(1, 'Chưa liên hệ'),
(2, 'Đã liên hệ'),
(3, 'Đã vào lớp'),
(4, 'Đã hoàn thành');
...
--
-- AUTO_INCREMENT for table `vdh_status`
--
ALTER TABLE `vdh_status`
